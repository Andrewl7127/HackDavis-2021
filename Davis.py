...
def mobile():
    ...
    zippy = talk("What is your zip code?")
    ...
    def get_message(phone):
        ...
        auth_token  = "4bc7af7e76b4a975a90d2ee67f2fc22b"
...
def main():
    ...
    say("Welcome to our app! Say update for an update on COVID-19 cases and deaths near you." + 
        " Say news for the top 5 COVID-19 headlines Say mobile to get daily updates to your mobile phone." 
        ...
        while flag == False:
            if "exit".find(response) > -1:
                ...
                if "options".find(response) > -1:
                    say("Say update for an update on COVID-19 cases and deaths near you!" + 
        " Say news for the top 5 COVID-19 headlines Say mobile to get daily updates to your mobile phone!" 
        + " Say question to ask questions to our chat bot! If at any point you would like to stop talking say exit!" 
        + " Say options for a repeat of the options!")
                else:
